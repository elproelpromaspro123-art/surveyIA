                ...
                <div className="relative z-10 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-white/10 group-hover:border-white/20 rounded-2xl p-6 transition-all duration-300">
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <div className="flex items-center gap-3">
                      <label className="relative inline-block cursor-pointer group flex-1">
                        <div className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-secondary/20 to-purple-500/20 border border-secondary/30 hover:border-secondary/50 hover:from-secondary/30 hover:to-purple-500/30 transition-all duration-300">
                      ...
                      {image && (
                        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-green-500/10 border border-green-500/30">
                          <div className="w-8 h-8 rounded-md overflow-hidden border border-green-500/30">
                    ...
                    {!image && (
                      <p className="text-xs text-muted-foreground mt-2">💡 Tip: You can also paste images with Ctrl+V</p>
                    )}
                  </div>
